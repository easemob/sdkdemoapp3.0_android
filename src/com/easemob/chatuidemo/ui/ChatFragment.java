...
public class ChatFragment extends EaseChatFragment implements EaseChatFragmentHelper{
    ...
    protected void setUpView() {
        ...
        // 判断下当前聊天模式，只有为群聊和单聊才检测输入框内容，聊天室不检测
        if(chatType == Constant.CHATTYPE_GROUP || chatType == Constant.CHATTYPE_SINGLE){
        ...
        if(resultCode == Activity.RESULT_OK){
            ...
            case REQUEST_CODE_SELECT_FILE: //发送选中的文件
                ...
                case REQUEST_CODE_AT_MEMBER: // 选择要 @ 的群成员加入到list中并设置特殊状态显示
                    ...
                    if(atMembers.contains(username)){
                        return;
                    }
    ...
    public void onSetMessageAttributes(EMMessage message) {
        ...
        if(isReadFire && (message.getType() == Type.TXT
