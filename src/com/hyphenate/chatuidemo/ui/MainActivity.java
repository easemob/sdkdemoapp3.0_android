...
@SuppressLint("NewApi") public class MainActivity extends BaseActivity {
    ...
    public class MyContactListener implements EMContactListener {
        ...
        @Override public void onContactDeleted(final String username) {
            runOnUiThread(new Runnable() {
                public void run() {
                    if (ChatActivity.activityInstance != null && ChatActivity.activityInstance.toChatUsername != null && username.equals(
...
//                        });
    ...
    private void showExceptionDialog(String exceptionType) {
        ...
        if (!MainActivity.this.isFinishing()) {
            ...
            try {
                if (exceptionBuilder == null) exceptionBuilder = new android.app.AlertDialog.Builder(MainActivity.this);
