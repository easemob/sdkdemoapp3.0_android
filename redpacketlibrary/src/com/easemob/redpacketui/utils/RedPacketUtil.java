...
public class RedPacketUtil {
     ...
     * @return EMMessage
     */
    public static EMMessage createTRMessage(Context context, RedPacketInfo redPacketInfo, String toChatUsername) {
        String transferAmount = redPacketInfo.redPacketAmount;
        ...
        message.setAttribute(RPConstant.EXTRA_TRANSFER_PACKET_TIME, redPacketInfo.transferTime);
        message.setAttribute(RPConstant.EXTRA_RED_PACKET_TYPE, redPacketInfo.redPacketType);
        return message;
    }
     ...
     * @return RedPacketInfo
     */
    private static RedPacketInfo wrapperTransferInfo(EMMessage message) {
     ...
     * @param activity FragmentActivity
     */
    public static void openADRedPacket(EMMessage message, final FragmentActivity activity) {
        final ProgressDialog progressDialog = new ProgressDialog(activity);
        progressDialog.setCanceledOnTouchOutside(false);
        String redPacketId = message.getStringAttribute(RPConstant.EXTRA_RED_PACKET_ID, "");
        RPRedPacketUtil.getInstance().openADRedPacket(redPacketId, activity, true, new RPADPacketCallback() {
            @Override
            public void onReceivePacketSuccess(String s) {
            ...
            @Override
            public void shareToFriends(FragmentActivity activity, String shareMsg, String shareUrl, String campaignCode) {

            }

            @Override
            public void loadLandingPage(String url, String title) {
